...
- [ ] **P1-01** Add marker security rule to AGENT_BOOTSTRAP.md
- [ ] **P1-02** Add marker vocabulary reference to AGENT_BOOTSTRAP.md
...
- [ ] **P1-11** Add quick-lookup to AGENT_FIX.md
- [ ] **P1-12** Add quick-lookup to AGENT_FEEDBACK.md
...
- [ ] **P2-01** Add contracts to ta-template.md
- [ ] **P2-02** Add contracts to sd-template.md
- [ ] **P2-03** Add contracts to tai-template.md
- [ ] **P2-04** Add contracts to sdi-template.md
- [ ] **P2-05** Add contracts to tc-template.md
- [ ] **P2-06** Add contracts to rt-template.md
- [ ] **P2-07** Add contracts to ri-template.md
- [ ] **P2-08** Add contracts to bug-report-template.md
- [ ] **P2-09** Add contracts to uat-pack-template.md
- [ ] **P2-10** Add contracts to sprint-template.md
- [ ] **P2-11** Add contracts to sprint-goal-template.md
- [ ] **P2-12** Add contracts to dev-plan-template.md
- [ ] **P2-13** Add contracts to refinement-notes-template.md
- [ ] **P2-14** Add contracts to business-analysis-template.md
- [ ] **P2-15** Add contracts to bai-template.md
- [ ] **P2-16** Add contracts to functional-spec-template.md
- [ ] **P2-17** Add contracts to decision-log-template.md
...
- [ ] **P3-01** Add MARKER_RULES to linter.js
- [ ] **P3-02** Add controlled vocabulary constants
- [ ] **P3-03** Add frontmatter parsing for new fields
- [ ] **P3-04** Add section heading detection
- [ ] **P3-05** Create linter tests for marker rules
- [ ] **P3-06** Add `--warn-markers` CLI flag (warn mode)
- [ ] **P3-07** Update linter documentation
